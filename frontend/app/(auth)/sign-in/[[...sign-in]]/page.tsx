      ...
      <div className="relative flex-1 hidden lg:flex flex-col justify-between p-12 overflow-hidden border-r border-slate-800/80 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950/40">
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          ...
          <p className="text-slate-400 text-base leading-relaxed">
            Automatically ingest <code className="text-indigo-300 font-mono text-xs px-1.5 py-0.5 rounded bg-slate-900 border border-slate-800">orders.csv</code> and <code className="text-indigo-300 font-mono text-xs px-1.5 py-0.5 rounded bg-slate-900 border border-slate-800">payments.csv</code>, discover discrepancies in seconds, and leverage AI root-cause analysis.
          </p>
